...
rm(asi_index, same_race, same_sex, last_year_parsed)

#####################################
### DELETE THIS IN FINAL DRAFTING ###
#####################################
write_csv(assembled_dataset, file = "assembled-dataset.csv")
...
The current study included 182 couples. 172 couples were heterosexual, 7 were same-sex female, and 3 were same-sex male. The majority of couples were married (91.8%), while 8.2% were not married but in a committed relationship. Overall, the sample was split evenly between genders, with women making up 51% and men making up 49%. Most of the participants in the sample identified as white (74%), 10% as Asian or Asian American, 6.6% as Black or African American, and 5.8% as Latinx or Hispanic. 4 individuals identified as Middle Eastern, and 5 replied Other or Prefer not to Answer. The majority of the individuals reported working from home (61.5%), 20% were working in person, and 18.5% did not answer the question or reported Other. The average age for participants was 45.8 (middle-age) with SD = 8.35. Their average annual income was \$76,618 and the variance in income was wide with a SD = $105,704. 120 couples had children, while 62 did not. Finally, the reported number of children was 1.34 but the variance was large across the couples with an SD = 2.17. 18 couples had discrepancies in the reported number of children, with individuals disagreeing. We used the higher reported number, as we decided that it was more likely for children to be disregarded than fabricated. 

  We omitted participants who did not answer questions that were crucial to our analysis. Since our first research question measured the relationship satisfaction among fathers, we omitted the 7 same-sex female couples from that part of the analysis. Overall there were 172 different-gender couples and 10 same-sex couples. 161 couples were same-race and 21 were mixed-race.
