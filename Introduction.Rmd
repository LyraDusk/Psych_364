...
Equitable division of childcare labor increases relationship satisfaction in cohabiting couples [@CarlsonDDivision]. Conversely, partner-objectification, or the way a person views their partner as an object, decreases relationship satisfaction for both men and women [@StrelanP; @ZurbriggenE] via self-objectification, the way someone internally views themself as an object. [@RamseyL]. The aim of the current study was to examine how the dynamic of objectification between partners affects the division of childcare labor in a dyadic framework of cohabiting couples.  
