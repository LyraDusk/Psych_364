...
gatekeep <- premeasures %>%
  select(ResponseId, dyadID, gatekeeping_1, gatekeeping_2, gatekeeping_3, gatekeeping_4, gatekeeping_5, gatekeeping_6, gatekeeping_7, gatekeeping_8, gatekeeping_9, gatekeeping_10, gatekeeping_11, gatekeeping_12, gatekeeping_13, gatekeeping_14, gatekeeping_15, gatekeeping_16) %>%
  mutate_at(vars(-ResponseId, -dyadID), stripChars)

corr.test(select(gatekeep, gatekeeping_1, gatekeeping_2, gatekeeping_3, gatekeeping_4, gatekeeping_5, gatekeeping_6, gatekeeping_7, gatekeeping_8, gatekeeping_9, gatekeeping_10, gatekeeping_11, gatekeeping_12, gatekeeping_13, gatekeeping_14, gatekeeping_15, gatekeeping_16))
#looking good, nothing needs to be reversed

alpha(select(gatekeep, gatekeeping_1, gatekeeping_2, gatekeeping_3, gatekeeping_4, gatekeeping_5, gatekeeping_6, gatekeeping_7, gatekeeping_8, gatekeeping_9, gatekeeping_10, gatekeeping_11, gatekeeping_12, gatekeeping_13, gatekeeping_14, gatekeeping_15, gatekeeping_16))
#.92 alpha, nothing that looks like it needs reversing

gatekeep$gatekeep_total <- rowMeans(select(gatekeep, gatekeeping_1, gatekeeping_2, gatekeeping_3, gatekeeping_4, gatekeeping_5, gatekeeping_6, gatekeeping_7, gatekeeping_8, gatekeeping_9, gatekeeping_10, gatekeeping_11, gatekeeping_12, gatekeeping_13, gatekeeping_14, gatekeeping_15, gatekeeping_16), na.rm = TRUE)
...
Also note that (for unknown reasons) there are about 100 people missing from the daily diaries. I've asked Randi about that, will follow up.

```{r dataset_assembly}
assembled_dataset <- premeasures %>%
  select(ResponseId, dyadID, gender, Q139) %>%
