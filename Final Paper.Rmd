---
title             : "Self-objectification and Childcare Labor in Teleworking Couples"
shorttitle        : "Objectification and Childcare"
...
Equitable division of childcare labor increases relationship satisfaction in cohabiting couples [@CarlsonDDivision]. Conversely, partner-objectification (viewing one's partner as an object) decreases relationship satisfaction for both men and women [@StrelanP; @ZurbriggenE] via self-objectification (viewing oneself as an object). [@RamseyL]. Objectification theory states that people who partner-objectify in relationships tend to dehumanize their partners [@FredrickB]. Because childcare is considered a service task, the aim of the current study was to examine how the dynamic of objectification between partners affects the division of childcare labor in a dyadic framework of cohabiting couples.       
...
Our sample originally included 182 couples, but exclusion criteria reduced that to 71. 70 couples were heterosexual, 1 was same-sex female, and no couples were same-sex male. We omitted participants who did not answer questions that were crucial to our analysis. Since our first research question measured the relationship satisfaction of fathers, we omitted the same-sex female couple from our analysis, as well as any couples that did not have children or did not complete the daily diaries. For the analysis of our first hypothesis, there were 70 heterosexual couples. No same-sex male couples in our sample had children. For the second and third hypotheses, as before, we omitted couples without children and who did not complete the daily diaries. Thus, the sample for our first research question included 71 couples, all with at least 1 child. 
...
When fathers did no childcare tasks, there was no statistically significant effect of either actor's or partner's gatekeeping on relationship satisfaction, ($b$ = -0.56, $SE$ = 0.32, $p$ = 0.08), ($b$ = -0.37, $SE$ = 0.30, $p$ = 0.23). The interaction between childcare tasks and actor's gatekeeping did not have a significant effect on relationship satisfaction for fathers, ($b$  $\leq$ 0.01, $SE$  $\leq$ 0.01, $p$ = 0.27). Similarly, the interaction between childcare tasks and partner's gatekeeping did not have a significant effect on relationship satisfaction for fathers, ($b$  $\leq$ 0.01, $SE$  $\leq$ 0.01, $p$ = 0.31).
...
t_table <- t_table %>%
  mutate(p = ifelse(t == 11.71,"< 0.01", p))
```
