...
### First Hypothesis
We hypothesized that higher childcare tasks would negatively affect father's relationship satisfaction. We used multilevel modeling and the Actor-Partner Interdependence Model [@Kenny] to test interaction between childcare, actor gatekeeping and partner gatekeeping. The APIM allows us to assess how the fathers and their partner's gatekeeping affect their childcare and relationship satisfaction. To arrive at our final model we used a mutiple regression model that included father's childcare contribution, actor and partner gatekeeping, and the interaction of actor and partner gatekeeping and childcare.
